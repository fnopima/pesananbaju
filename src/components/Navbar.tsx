      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="cursor-pointer" onClick={onOpenShopSettings} title="Pengaturan Identitas Toko">
              ...
              <div className="text-[10px] text-emerald-200 tracking-wider hidden sm:block">
                {shopProfile.tagline}
              </div>
            </div>

            <div className="hidden lg:flex items-center gap-2 pl-4 border-l border-emerald-800/80 text-xs">
              <span className="bg-emerald-900/60 px-2.5 py-1 rounded text-emerald-200">
          ...
          <div className="flex items-center gap-2 sm:gap-2.5">
            ...
            >
              <FileSpreadsheet size={15} className={syncState.isConnected ? 'text-emerald-300' : 'text-amber-300'} />
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold bg-emerald-700/80 hover:bg-emerald-700 border border-emerald-500/60 text-white transition relative shadow-xs"
            ...
            >
              ...
              {overdueOrders.length > 0 ? (
                <span className="bg-rose-500 text-white text-[10px] font-bold px-1.5 py-0.2 rounded-full flex items-center gap-0.5">
                  <AlertTriangle size={10} /> {overdueOrders.length}
                </span>
              ) : unpaidOrders.length > 0 ? (
                <span className="bg-emerald-900 text-emerald-200 text-[10px] font-bold px-1.5 py-0.2 rounded-full">
                  {unpaidOrders.length}
                </span>
              ) : null}
            </button>
            ...
            <button
              ...
              className="p-2 text-emerald-200 hover:text-white hover:bg-emerald-800/60 rounded-lg transition"
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-lg text-xs font-bold bg-white text-[#264936] hover:bg-stone-100 transition shadow-xs"
            >
              <Plus size={16} />
